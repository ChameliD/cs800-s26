...
This assignment focuses on reading and analyzing research papers in my research area (Table data extraction, Table Structure Recognition)using Keshav’s 1st-pass method.
